...
def main():
	...
	# check_rover_vs_base_u(estOdom,roverGpsNed)
	# check_rover_vs_base_v(estOdom,roverGpsNed)
	# check_rover_vs_base_w(estOdom,roverGpsNed)
...
def get_data(data, bag):
	...
	return flightMode, missionState, estOdom, baseGps, roverGps, refLla
...
def check_rover_vs_base_u(baseOdom, roverGpsNed):
	fig_num = 7
	plot_2(fig_num, baseOdom.time, baseOdom.velocity[0], 'odom u', roverGpsNed.time, roverGpsNed.velocity[0], 'gps u')

def check_rover_vs_base_v(baseOdom, roverGpsNed):
	fig_num = 8
	plot_2(fig_num, baseOdom.time, baseOdom.velocity[1], 'odom v', roverGpsNed.time, roverGpsNed.velocity[1], 'gps v')

def check_rover_vs_base_w(baseOdom, roverGpsNed):
	fig_num = 9
	plot_2(fig_num, baseOdom.time, baseOdom.velocity[2], 'odom w', roverGpsNed.time, roverGpsNed.velocity[2], 'gps w')
